...
async def evaluate_all_chat(folder_path):
    dest_folder = "Experiments/ConstrainedParodieGenerator/CalibrationResults/AllChat_fixed_beamsearch_cleanup/"
    if platform.system() == 'Linux':
        dest_folder = os.environ["VSC_DATA"] + "/CalibrationResults/AllChat_fixed_beamsearch_cleanup/"
