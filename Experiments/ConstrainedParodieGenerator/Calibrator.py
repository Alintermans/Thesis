...
def process_syllable_results(language_model_name):
    ...
    for result in results:
        ...
        avg_perplexities_difference.append(sum(perplexities_difference)/len(perplexities_difference))
        ...
        avg_correct_syllable_count.append(sum(correct_syllable_count)/len(correct_syllable_count))
        avg_duration.append(sum(duration)/len(duration))
        avg_correct_rhymes.append(sum(correct_rhymes)/len(correct_rhymes))
        avg_pos_similarity.append(sum(pos_similarity)/len(pos_similarity))
        avg_mean_deviation_pos_similarity.append(sum(mean_deviation_pos_similarity)/len(mean_deviation_pos_similarity))
        avg_correct_pos_lines.append(sum(correct_pos_lines)/len(correct_pos_lines))
        avg_overlap.append(sum(overlap)/len(overlap))
        avg_repetition_difference.append(sum(repetition_difference)/len(repetition_difference))
...
def process_rhyming_or_pos_results(language_model_name, constraint_type):
    ...
    for result_beams in results:
        ...
        for result_token in result_beamms:
            ...
            perplexities_per_beam.append(sum(perplexities)/len(perplexities))
            perplexities_difference_per_beam.append(sum(perplexities_difference)/len(perplexities_difference))
            syllable_differences_per_beam.append(sum(syllable_differences)/len(syllable_differences))
            mean_deviation_syllable_count_per_beam.append(sum(mean_deviation_syllable_count)/len(mean_deviation_syllable_count))
            correct_syllable_count_per_beam.append(sum(correct_syllable_count)/len(correct_syllable_count))
            duration_per_beam.append(sum(duration)/len(duration))
            correct_rhymes_per_beam.append(sum(correct_rhymes)/len(correct_rhymes))
            pos_similarity_per_beam.append(sum(pos_similarity)/len(pos_similarity))
            mean_deviation_pos_similarity_per_beam.append(sum(mean_deviation_pos_similarity)/len(mean_deviation_pos_similarity))
            correct_pos_lines_per_beam.append(sum(correct_pos_lines)/len(correct_pos_lines))
            overlap_per_beam.append(sum(overlap)/len(overlap))
            repetition_difference_per_beam.append(sum(repetition_difference)/len(repetition_difference))
...
def process_all_non_chat_results():
    ...
    for i in range(len(LANGUAGE_MODELS_NON_CHAT)):
        ...
        avg_perplexities_difference = sum(perplexities_difference)/len(perplexities_difference)
        avg_syllable_differences = sum(syllable_differences)/len(syllable_differences)
        avg_mean_deviation_syllable_count = sum(mean_deviation_syllable_count)/len(mean_deviation_syllable_count)
        avg_correct_syllable_count = sum(correct_syllable_count)/len(correct_syllable_count)
        avg_duration = sum(duration)/len(duration)
        avg_correct_rhymes = sum(correct_rhymes)/len(correct_rhymes)
        avg_pos_similarity = sum(pos_similarity)/len(pos_similarity)
        avg_mean_deviation_pos_similarity = sum(mean_deviation_pos_similarity)/len(mean_deviation_pos_similarity)
        avg_correct_pos_lines = sum(correct_pos_lines)/len(correct_pos_lines)
        avg_overlap = sum(overlap)/len(overlap)
        avg_repetition_difference = sum(repetition_difference)/len(repetition_difference)
...
def process_no_constraints_no_guardrails_results():
    ...
    for i in range(len(LANGUAGE_MODELS_CHAT)):
        ...
        avg_correct_paragraphs = sum(correct_paragraphs)/len(correct_paragraphs)
        avg_correct_lines = sum(correct_lines)/len(correct_lines)
        avg_perplexities = sum(perplexities)/len(perplexities)
        avg_perplexities_difference = sum(perplexities_difference)/len(perplexities_difference)
        avg_syllable_differences = sum(syllable_differences)/len(syllable_differences)
        avg_mean_deviation_syllable_count = sum(mean_deviation_syllable_count)/len(mean_deviation_syllable_count)
